...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex justify-between items-center p-4 sm:p-6 sm:px-24'>
        ...
        {userData ? 
        <div className='w-8 h-8 flex justify-center items-center rounded-full bg-black/80 text-white bold-medium relative group '>
          {userData.name[0].toUpperCase()}
          <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-10'>
            <ul className='list-none m-0 p-2 bg-gray-100 text-sm w-max'>
              {!userData.isAccountVerified && 
              <li onClick={sendVerificatioOtp} className='py-1 px-2 hover:bg-gray-200 cursor-pointer whitespace-nowrap'>
                Verify Email
                </li>
              }
